...
class MerlinBot:
    ...
    def perform_query(self, query):
        ...
        augmented_query = "\n\n---\n\n".join(contexts)+"\n\n-----\n\n"+"1."+query+ " "+ "along with confidence score. Confidence score is how much probable that the answer you have given is correct."
        #"\n\n-----\n\n"+"2."+"Give confidence score in percentage. Confidence score is how much probable that the answer you have given is correct."
        
        augmented_query2 = "\n\n---\n\n".join(contexts)+"\n\n-----\n\n"+"3. What are the distinct file names from where the answers are fetched."
